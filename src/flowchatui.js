...
$(".chat_icon").append(function() {
    return ($("<div>")
        ...
        .html('<div id="myForm" class="chat-popup"> <form action="" class="form-container"><h3>We are ChatConnect</h3><input type="email" placeholder="Type Email" name="msg" ><button id="btn-submit" type="submit">Start</button></form></div>')
    )
});
